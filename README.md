...
- [mem_usage.py](https://github.com/kavishgr/My-Python-Scripts/blob/master/mem_usage.py) - Print the system's memory usage, and if usage is >= 90%, print a warning. Can be executed as ad-hoc command for Ansible tasks.
